export default function Footer() {
  return (
    <footer className="text-center lg:text-left bg-lime-100 text-gray-600">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          ">
            ...
            <p>
              App to recommend you books according
              <br/>to your interest.
            </p>
          </div>
          <div className=""/>
      ...
      <div className="text-center p-6 bg-lime-150">
        <span>© 2022 Copyright:</span>
        <a className="text-gray-600 font-semibold" href="https://seemathapa.com.np/">Seema Thapa</a>
      </div>
    </footer>
  )
}
